...
if OMNI_INSTALLED:
    import my_omnipose
    from my_omnipose.utils import normalize99 # replace the cellpose version to avoid low-cell-density artifacts
    ...
    from my_omnipose.utils import sinebow
    import colour
    N = 29
    c = sinebow(N)
...
#             self.show()
    ...
    def compute_cprob(self):
        ...
        if not omni:
            ...
            maski = my_omnipose.core.compute_masks(dP, dist, bd, p,
                                                mask_threshold=self.cellprob,
                                                flow_threshold=thresh,
                                                resize=self.cellpix.shape[-2:],
